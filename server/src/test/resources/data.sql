...
INSERT INTO product (name, short_description, long_description, price, raiting, image)
    VALUES ('Product #1', 'Product one short description.', 'This is a very long description of product #1.', 5.50, 0.0, '/images/test-product-1.png')
    , ('Product #2', 'Product two short description.', 'This is a very long description of product #2.', 10.56, 0.0, '/images/test-product-2.png')
    , ('Product #3', 'Product three short description.', 'This is a very long description of product #3.', 2.74, 0.0, '/images/test-product-3.png')
    , ('Product #4', 'Product four short description.', 'This is a very long description of product #4.', 15.69, 0.0, '/images/test-product-4.png')
    , ('Product #5', 'Product five short description.', 'This is a very long description of product #5.', 42.59, 0.0, '/images/test-product-5.png');
